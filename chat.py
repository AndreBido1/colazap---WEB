...
class Chat:
    ...
    def verificar_mensagem(self, quantidade:int, contato:Contatos):
        ...
        sql = f"SELECT nome, mensagem FROM tb_mensagem m INNER JOIN tb_usuario u ON m.tel_remetente = u.tel WHERE m.tel_remetente = '{self.telefone_usuario}' AND m.tel_destinatario = '{contato.telefone}' OR m.tel_remetente = '{contato.telefone}' AND m.tel_destinatario = '{self.telefone_usuario}'"
    ...
    def retornar_contatos(self):
        ...
        for linha in resultado:
            ...
            # Criando a mensagem primeiro e incluindo na lista
            contato = {"nome":linha[0], "telfone":linha[1]}
    ...
    def mandar_mensagem(self, mensagem:str, tel_destinatario:Contatos) -> bool:
        ...
        val= (self.telefone_usuario, mensagem, tel_destinatario.telefone)
